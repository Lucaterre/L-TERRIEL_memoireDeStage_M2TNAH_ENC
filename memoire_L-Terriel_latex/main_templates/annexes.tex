...
.1 /B-Format\_pivot\_XML\_TEI\_Lectaurep/.
   .2 Doc/\DTcomment{regroupe la documentation sur le projet du fichier pivot XML TEI pour Lectaurep}.
        .3 Modélisation\_et\_documentation\_format\_pivot/.
           .4 template\_pivot\_TEI\_lectaurep.xml\DTcomment{Canevas (\textit{templates}) pour formaliser les attentes et les réflexions des acteurs pour l'inclusion des données et métadonnées Lectaurep dans la TEI.}.
           .4 Les ODD aux formats : XML, PDF et HTML.\DTcomment{La documentation standard TEI pour le fichier pivot TEI Lectaurep.}.
   ...
   .2 Generator\_Lectaurep2TEI/\DTcomment{CLI Python permettant de simuler 
        ...
        .3 Sets\_test\_Legay/\DTcomment{Contient un ensemble de fichiers correspondant aux données fournies par Lectaurep pour tester le programme \textit{generator Lectaurep2TEI} et généré une première version du format pivot.}.
            .4  Data\_xml\_alto/\DTcomment{fichiers XML ALTO correspondants aux transcriptions vérité terrain récupérés sur \textit{ShareDocs} relatives aux images numérisées du répertoire de notaire d'Ernest Legay (étude XXIII).}.
            ...
            .4  images/\DTcomment{Images numérisées du répertoire de notaire d'Ernest Legay (étude XXIII) issues du \textit{Golden Set} de \textit{ShareDocs}.}.
...
.1 /C-Application\_Kraken\_Benchmark/.
   ...
   .2 KB-app/.\DTcomment{Dossier contenant les fichiers pour faire fonctionner l'application \textit{\textit{Kraken-Benchmark}}.}.
    .3 STS\_Tools/.\DTcomment{Le \textit{package} Python \textit{Sequences to Similarity} créée pour l'application \textit{\textit{Kraken-Benchmark}} contient deux modules Python.}.
        .4 STSig.py.\DTcomment{module Python \textit{Sequences To Signals} (en cours de développement); module pour créer des visualisations et des métriques pour comparer deux chaînes de caractères expérimentales.}.
...
\begin{figure}
  \begin{sideways}
    \includegraphics[width=24cm, height=16cm]{modèle_metadonnées_vise_V4.png}
  \end{sideways}
  \centering
...
\begin{figure}
    \centering
    \centerline{\fbox{\includegraphics[width=18cm, height=22.5cm]{Generateur-XML-TEI.png}}}
...
\begin{figure}
    \centering
    \centerline{\fbox{\includegraphics[width=18cm]{transkribus/detail-model-transkribus.png}}}
...
\begin{figure}
    \centering
    \centerline{\fbox{\includegraphics[width=18cm]{transkribus/compare-texts-transkribus.png}}}
...
\begin{figure}
    \centering
    \centerline{\fbox{\includegraphics[width=18cm, height=22.5cm]{images_partie_3/Kraken-Benchmark_modelisation.png}}}
